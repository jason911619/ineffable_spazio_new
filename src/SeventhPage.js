...
const SeventhPage=()=>{
    ...
    <div className="main_bg" style={mainBg}>
        ...
        <h2 style={{ fontWeight:"lighter", fontSize:"18px", color: "white"}}>特殊標準專案</h2>
    ...
    <h2 style={{ fontWeight:"lighter", fontSize:"18px", color: "white"}}>商業空間專案</h2>
    ...
    <h2 style={{ fontWeight:"lighter", fontSize:"18px", color: "white"}}>住宅樓宇專案</h2>
